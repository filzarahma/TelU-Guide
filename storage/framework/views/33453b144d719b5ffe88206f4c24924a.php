...
<body>
    ...
    <div class="container">
        <div class="text-center">
            ...
            <img src="assets/img/jamal.jpg" class="rounded-circle border border-3" width="150">
    ...
    <div class="col-md-8 container">
        <div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <a class="btn btn-info " target="__blank" href="/securityInfo">Back</a>
                </div>
            </div>
        </div>
    </div>
</body>
</html><?php /**PATH C:\xampp\htdocs\tubes2\resources\views/securityViewProfile.blade.php ENDPATH**/ ?>