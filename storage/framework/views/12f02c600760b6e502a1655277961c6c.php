...
<div>
        <nav class="navbar" style="background-color: #ed212b;">
            ...
            <ul class="nav justify-content-rigth">
                ...
                <li class="nav-item">
                    <a class="nav-link" style="color: #ffffff; font-size: 14px;" href="/maps">Maps</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" style="color: #ffffff; font-size: 14px;" href="/securityInfo">Security</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" style="color: #ffffff; font-size: 14px;" href="/profile">Profile</a>
                </li>
            </ul>
        </nav>        
    </div>
...
</html><?php /**PATH C:\xampp\htdocs\tubes2\resources\views/tes.blade.php ENDPATH**/ ?>